...
export default function MaaraaikaishuollotPage() {
  return (
    <>
      <Navigation />
        ...
        <section className="flex-1 flex items-center justify-center py-32">
          <div className="container mx-auto px-4 text-center">
            <div className="inline-flex items-center gap-2 border border-primary/30 px-4 py-2 mb-8">
              ...
              <span className="text-primary text-xs font-medium tracking-widest uppercase">Kaikki merkit</span>
            </div>
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-12 leading-relaxed">
              Ammattitaitoiset huollot kaikille automerkeille ilman merkkirajoituksia.
            </p>
