...
const features = [
  {
    icon: Wrench,
    title: "KAIKKI MERKIT",
    description: "Monimerkkikorjaamona huollamme kaikki automerkit ja mallit.",
  },
  {
    icon: Shield,
    title: "2V TAKUU",
          ...
          <div className="relative z-10 container mx-auto px-4 py-32">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 border border-primary/30 px-4 py-2 mb-6">
                ...
                <span className="text-primary text-sm font-medium tracking-widest uppercase">Monimerkkikorjaamo — Huoltopalvelut</span>
              </div>
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl leading-relaxed">
                Ammattitaitoiset huoltopalvelut kaikkiin automerkkeihin.
                BMW, Mercedes, Toyota tai Ford — pidämme autosi kunnossa ja turvallisena.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Kaikki merkit — valitse tarpeisiisi sopiva huoltopaketti
              </p>
            </div>
        ...
        <section className="py-20 bg-background border-y border-border">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">Huollamme kaikkia merkkejä — tässä osa asiakkaistamme</p>
            </div>
        ...
        <section className="py-24 bg-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Ota yhteyttä ja sovi sopiva huoltoaika — hoidamme kaikki merkit.
            </p>
